        ...
        col.innerHTML = `
          <div class="card h-100 border-0">
            ...
            <div class="card-body row">
              <div class="col-3">
                <img src=${category.authors[0].profile_picture} class="rounded-circle" alt="..." height="30" width="30">
              </div>
              <div class="col-9">
                <h5 class="card-title">${category.title}</h5>
                <p class="card-text">${category.authors[0].profile_name} ${category.authors[0].verified ? '<img src="./verified.png" height="20" width="20">' : ""}</p>
